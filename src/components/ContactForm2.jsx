            ...
            <div className="relative border-b border-gray-300">
              ...
              <div className="text-gray-400">
                <select
                  ...
                  name="budget"
                >
                  <option value="less than $5,000"> أقل من 10,000 ريال  </option>
                  <option value="$5,000 - $10,000">(10,000 - 20,000 ريال) </option>
                  <option value="$10,000 - $20,000">(20,000 - 30,000 ريال) </option>
                  <option value="$20,000 - $40,000">(30,000 - 40,000 ريال) </option>
                  <option value="$40,000+">40,000+ ريال</option>
                </select>
